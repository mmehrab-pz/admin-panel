...
export default function TotalIncomeCard2() {
  return (
    <Box
      sx={{
        width: "367px",
        ...
        "&::before": {
          ...
          position: "absolute",
          background:
            "linear-gradient(140.9deg, #ffc107 -14.02%, rgba(144, 202, 249, 0) 70.50%);",
        },
        "&::after": {
          content: '""',
          width: "210px",
          ...
          position: "absolute",
          background:
            "linear-gradient(210.04deg, #ffc107 -50.94%, rgba(144, 202, 249, 0) 83.49%)",
        },
      }}
    >
      <Box
